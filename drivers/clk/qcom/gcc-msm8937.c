...
static struct clk_rcg2 apss_ahb_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_data = gcc_parent_names_ao_0,
		.num_parents = 3,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 cpp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "cpp_clk_src",
		.parent_data = gcc_parent_names_10,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 sdcc1_apps_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_data = gcc_parent_names_18,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 sdcc2_apps_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_data = gcc_parent_names_19,
		.num_parents = 4,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 camss_gp0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_data = gcc_parent_names_20,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 esc0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "esc0_clk_src",
		.parent_data = gcc_parent_names_11,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 esc1_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "esc1_clk_src",
		.parent_data = gcc_parent_names_12,
		.num_parents = 5,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 gfx3d_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "gfx3d_clk_src",
		.parent_data = gcc_parent_names_14,
		.num_parents = 6,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_rcg2_ops,
	},
...
static struct clk_rcg2 mdp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "mdp_clk_src",
		.parent_data = gcc_parent_names_15,
		.num_parents = 6,
		.ops = &clk_rcg2_ops,
	},
};
...
static struct clk_rcg2 pclk0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "pclk0_clk_src",
		.parent_data = gcc_parent_names_16,
		.num_parents = 5,
		.flags = CLK_SET_RATE_PARENT | CLK_GET_RATE_NOCACHE,
		.ops = &clk_pixel_ops,
	},
...
static struct clk_rcg2 pclk1_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		.name = "pclk1_clk_src",
		.parent_data = gcc_parent_names_17,
		.num_parents = 5,
		.flags = CLK_SET_RATE_PARENT | CLK_GET_RATE_NOCACHE,
		.ops = &clk_pixel_ops,
	},
