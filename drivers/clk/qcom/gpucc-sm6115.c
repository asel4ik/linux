...
static struct clk_alpha_pll_postdiv gpu_cc_pll0_out_aux2 = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_hws = (const struct clk_hw*[]){ &gpu_cc_pll0.clkr.hw },
		.num_parents = 1,
...
static struct clk_alpha_pll_postdiv gpu_cc_pll1_out_aux = {
	...
	.clkr.hw.init = &(struct clk_init_data){
		...
		.parent_hws = (const struct clk_hw*[]){  &gpu_cc_pll1.clkr.hw, },
		.num_parents = 1,
		.flags = CLK_SET_RATE_PARENT,
		.ops = &clk_alpha_pll_postdiv_ops,
	},
