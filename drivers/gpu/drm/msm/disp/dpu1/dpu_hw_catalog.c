...
static const struct dpu_mdp_cfg sm6115_mdp[] = {
	...
	.base = 0x0, .len = 0x494,
	.features = 0,
	.highest_bank_bit = 0x1, /* qcom,sde-highest-bank-bit = <0x1> */
	.clk_ctrls[DPU_CLK_CTRL_VIG0] = {
		.reg_off = 0x2AC, .bit_off = 0},
	.clk_ctrls[DPU_CLK_CTRL_DMA0] = {
		.reg_off = 0x2AC, .bit_off = 8},
...
/*
 * sm6115_cfg_init(): populate sm6115 dpu sub-blocks reg offsets
 * and instance counts.
 */
static void sm6115_cfg_init(struct dpu_mdss_cfg *dpu_cfg)
{
	*dpu_cfg = (struct dpu_mdss_cfg){
...
static const struct dpu_mdss_hw_cfg_handler cfg_handler[] = {
	...
	{ .hw_rev = DPU_HW_VER_630, .cfg_init = sm6115_cfg_init},
