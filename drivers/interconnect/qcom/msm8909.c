...
static struct qcom_icc_node *msm8909_snoc_mm_nodes[] = {
	[MAS_MDP] = &mas_mdp,
	[MAS_VENUS] = &mas_venus,
	[MAS_VFE] = &mas_vfe,
	[MM_INT_0] = &mm_int_0,
...
static const struct qcom_icc_desc msm8909_snoc_mm = {
	.type = QCOM_ICC_NOC,
	.nodes = msm8909_snoc_mm_nodes,
	.num_nodes = ARRAY_SIZE(msm8909_snoc_mm_nodes),
	.regmap_cfg = &msm8909_snoc_regmap_config,
	.qos_offset = 0x7000,
};
...
static const struct of_device_id msm8909_noc_of_match[] = {
	...
	{ .compatible = "qcom,msm8909-snoc-mm", .data = &msm8909_snoc_mm },
	{ }
};
