...
static struct qcom_icc_node mas_smmnoc_bimc = {
	...
	.channels = 2,
	.buswidth = 16,
	.mas_rpm_id = ICBID_MASTER_SMMNOC_BIMC,
	.slv_rpm_id = -1,
	.qos.ap_owned = true,
...
static struct qcom_icc_node mas_sdcc_3 = {
	...
	.buswidth = 8,
	.mas_rpm_id = ICBID_MASTER_SDCC_3,
	.slv_rpm_id = -1,
	.qos.qos_mode = NOC_QOS_MODE_FIXED,
	.qos.areq_prio = 0,
	.qos.prio_level = 0,
...
static struct qcom_icc_node mas_xm_usb_hs1 = {
	...
	.buswidth = 8,
	.mas_rpm_id = ICBID_MASTER_XM_USB_HS1,
	.slv_rpm_id = -1,
...
static struct qcom_icc_node mas_venus_0 = {
	...
	.buswidth = 16,
	.mas_rpm_id = ICBID_MASTER_VIDEO_P0,
	.slv_rpm_id = -1,
	.qos.ap_owned = true,
	.qos.qos_mode = NOC_QOS_MODE_BYPASS,
	.qos.areq_prio = 0,
...
static struct qcom_icc_node mas_venus_1 = {
	...
	.buswidth = 16,
	.mas_rpm_id = ICBID_MASTER_VIDEO_P1,
	.slv_rpm_id = -1,
	.qos.ap_owned = true,
	.qos.qos_mode = NOC_QOS_MODE_BYPASS,
	.qos.areq_prio = 0,
...
static struct qcom_icc_node slv_smmnoc_bimc = {
	...
	.buswidth = 16,
	.mas_rpm_id = -1,
	.slv_rpm_id = ICBID_SLAVE_SMMNOC_BIMC,
	.qos.ap_owned = true,
	.qos.qos_mode = NOC_QOS_MODE_INVALID,
